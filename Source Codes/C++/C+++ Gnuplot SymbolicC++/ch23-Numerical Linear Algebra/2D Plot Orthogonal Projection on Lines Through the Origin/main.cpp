...
int main() {
	...
	cout <<"Standard Matrix for orthogonal projection on line through origin with angle θ with the positive x-axis of " << theta << " :" << "\n" << ArmaA <<endl;
	...
	gp << "plot '-' with vectors title 'x','-' with vectors title 'orthogonal projection of x on l' lc 'green', f(x) title 'l'  dashtype 3\n";
