...
int main(int argc, char** argv)
{
	...
	matrixA[0][0] = division(4,3);
	matrixA[0][1] = halving(division(4,3));
	matrixA[0][2] = halving(division(4,3));
	matrixA[1][0] = matrixA[0][1];
	matrixA[1][1] = division(4,3);
	matrixA[1][2] = halving(division(4,3));
	matrixA[2][0] = matrixA[0][2];
	matrixA[2][1] = matrixA[1][2];
	matrixA[2][2] = division(4,3);
