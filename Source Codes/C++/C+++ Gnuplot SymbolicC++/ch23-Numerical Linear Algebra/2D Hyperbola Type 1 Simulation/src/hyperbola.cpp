...
int main(int argc, char const *argv[])
{
	...
	int w = 1280;
	int h = 720;
	std::string title = "Hyperbola Type 1 Simulation";
	initImgui(w, h, title);
	...
	while (!glfwWindowShouldClose(window) && flag == true)
	{
		...
		ImVec2 wave_N1 = {coshf((float)i)*alpha + strokex, sinhf((float)i)*beta + strokey};
		ImVec2 wave_N2 = {coshf((float)i)*alpha + strokex, -sinhf((float)i)*beta + strokey};
		ImVec2 wave_N3 = {-coshf((float)i)*alpha + strokex, sinhf((float)i)*beta + strokey};
		ImVec2 wave_N4 = {-coshf((float)i)*alpha + strokex, -sinhf((float)i)*beta + strokey};
		...
		ImGui::PlotLines("", func, NULL, display_count, 0, NULL, -5.0f, 5.0f, ImVec2(0, 100));
