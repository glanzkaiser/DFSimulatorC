...
float a = 1.2; //  the radius of the cylinder
float h = 2; //  the height of the cylinder
///////////////////////////////////////////////////////////////////////////////
// print itself
///////////////////////////////////////////////////////////////////////////////
void Sphere::printSelf() const
{
    std::cout << "======== Sphere & Ellipsoid ========\n"
              << "        Cylinder Radius: " << a << "\n"
              << "        Cylinder height: " << h << "\n"
...
void Sphere::buildVerticesSmooth()
{
	...
	float sectorAngle;
	freopen ("datapoints.txt","w",stdout); 
	cout << "i" <<"\t\t" << "j" <<"\t\t\t\t"<< "x" <<  "\t\t\t\t" << "y" <<  "\t\t\t\t" << "z" << endl;

	for(int i = 0; i <= stackCount; ++i)
	{	
		// To create a cylinder we need to run the z variable in the for loop.
		// 0.5 is the decrement interval
		for(z = 1; z >= -1; z=z-0.5)	
		{
			...
			for(int j = 0; j <= sectorCount; ++j)
			{
				...
				// vertex position
				// a is the radius of the circle for the cylinder
				x = a  * cosf(sectorAngle);             //  a * cos(v)
				y = a  * sinf(sectorAngle);             //  a * sin(v)
			
				cout << setprecision(3) << i <<"\t\t" << j << "\t\t\t\t" << x<<  "\t\t\t\t" << y << "\t\t\t\t" << z << endl;
...
// This create the left sphere / object
///////////////////////////////////////////////////////////////////////////////
