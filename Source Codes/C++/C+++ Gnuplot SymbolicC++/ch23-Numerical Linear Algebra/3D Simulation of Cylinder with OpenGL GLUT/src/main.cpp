...
int main(int argc, char **argv)
{
    ...
    //texId = loadTexture("ps2imageFreya.bmp", true);
...
void showInfo()
{
    ...
    float a = 1.2; //  the cylinder radius
    float h = 2; //  the cylinder height
    
    ss << "Cylinder Radius: " << a << std::ends;
    drawString(ss.str().c_str(), 1, screenHeight-TEXT_HEIGHT, color, font);
    ss.str("");

    ss << "Cylinder height: " << h << std::ends;
