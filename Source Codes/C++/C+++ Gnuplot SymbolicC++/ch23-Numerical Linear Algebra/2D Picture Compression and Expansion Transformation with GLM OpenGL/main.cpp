...
int main()
{
	...
	cout << "Press W to perform expansion in the y-axis direction" << endl;
        cout << "Press A to perform compression in the x-axis direction" << endl;
	cout << "Press S to perform compression in the y-axis direction" << endl;
        cout << "Press D  to perform expansion in the x-axis direction" << endl;
        ...
        while (window.pollEvent(windowEvent))
	{
		...
		cout << "scale toward x-axis : " << scaledirectionx << endl;
		cout << "scale toward y-axis : " << scaledirectiony << endl;
		break;
            }
        }
	...
	scaleMat = glm::scale(scaleMat, glm::vec3(scaledirectionx, scaledirectiony, 0.0f));

        glUniformMatrix4fv(uniTrans, 1, GL_FALSE, glm::value_ptr(scaleMat));
