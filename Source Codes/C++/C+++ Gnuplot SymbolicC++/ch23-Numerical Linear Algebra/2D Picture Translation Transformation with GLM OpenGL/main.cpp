...
int main()
{
        ...
        while (window.pollEvent(windowEvent))
	{
		...
		cout << "translation toward x-axis : " << translatedirectionx << endl;
		cout << "translation toward y-axis : " << translatedirectiony << endl;
		break;
            	}
        }
	...
	translationMat = glm::translate(translationMat, glm::vec3(translatedirectionx, translatedirectiony, 0.0f));

        glUniformMatrix4fv(uniTrans, 1, GL_FALSE, glm::value_ptr(translationMat));
