...
private:	
	...
	unsigned int load_texture_image(std::string file_name, bool& load_complete)
	{
		...
		unsigned char* image_data = stbi_load("/opt/hamzstlib/LearnOpenGL/resources/textures/container.jpg", &width, &height, &num_components, 0);
		//unsigned char* image_data = SOIL_load_image("/root/SourceCodes/CPP/images/sample.png", &width, &height, 0, SOIL_LOAD_RGB);
